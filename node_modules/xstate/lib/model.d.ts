...
export interface Model<TContext, TEvent extends EventObject, TModelCreators = never> {
...
export declare function createModel<TContext, TEvent extends EventObject>(initialContext: TContext): Model<TContext, TEvent, never>;
