...
export declare const wrapSpaceMembershipCollection: (makeRequest: {
    ...
    (opts: import("../common-types").MROpts<"ApiKey", "get", false>): Promise<import("./api-key").ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "getMany", false>): Promise<import("../common-types").CollectionProp<import("./api-key").ApiKeyProps>>;
    (opts: import("../common-types").MROpts<"ApiKey", "create", false>): Promise<import("./api-key").ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "createWithId", false>): Promise<import("./api-key").ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "update", false>): Promise<import("./api-key").ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "delete", false>): Promise<any>;
    (opts: {
    ...
    (opts: {
        ...
        payload: Pick<import("./role").RoleProps, "description" | "name" | "policies" | "permissions">;
    } & {
        headers?: Record<string, unknown> | undefined;
    }): Promise<import("./role").RoleProps>;
    (opts: {
