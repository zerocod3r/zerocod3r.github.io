...
export declare const wrapApiKeyCollection: (makeRequest: {
    ...
    (opts: import("../common-types").MROpts<"ApiKey", "get", false>): Promise<ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "getMany", false>): Promise<import("../common-types").CollectionProp<ApiKeyProps>>;
    (opts: import("../common-types").MROpts<"ApiKey", "create", false>): Promise<ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "createWithId", false>): Promise<ApiKeyProps>;
    (opts: import("../common-types").MROpts<"ApiKey", "update", false>): Promise<ApiKeyProps>;
